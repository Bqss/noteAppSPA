    ...
    return (
        <nav className="transition-colors duration-300">
            <div className=" flex justify-between  mt-10 mx-auto bg-secondary-light dark:bg-secondary-dark px-5 py-4 rounded-lg items-center">
                ...
                <div>
                    <Link href="/">
                        <button className="  py-2 text-blue-400  dark:text-slate-300   px-4 rounded-sm">
                            Home
                        </button>
                    </Link>
                    <Link href="/archive">
                        <button className=" text-blue-400  dark:text-slate-300  py-2  px-4 rounded-sm">
                            Archive
                        </button>
                    </Link>
                </div>
                    ...
                    <div className="relative">
                        <Menu >
                            ...
                            >
                                <Menu.Items
                                    className={
                                        "absolute top-16 right-0 bg-blue-500 p-2 rounded-md flex flex-col space-y-2 w-max"
                                    }
                                >
                                    <Menu.Item className="py-2 px-4 text-white rounded-md hover:bg-blue-400 transition-colors duration-150">
                                        <Link href="/profile">
                                            View Profile
                                        </Link>
                                    </Menu.Item>
